...
**Example with person index:** `filter 3 pred/ amount > 500 pred/ loanType c pred/ isPaid n`
**Example without person index:** `filter pred/ amount < 200 pred/ isPaid y`
**Example to clear predicates:** `filter clear`
